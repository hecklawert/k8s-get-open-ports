...
k8s-get-open-ports project, is a monitoring system. It collects all [nodePorts](https://kubernetes.io/docs/concepts/services-networking/service/#type-nodeport) from the cluster where it resides at given intervals using a [Cronjob](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/) and displays the result in JSON format in the logs of the job.
